...
**[Download the Mac app (DMG)](https://github.com/johnBgood/local-writing-assistant/releases/download/v0.4.6/LocalWriter-0.4.6-arm64-beta.dmg)** · **[Download the Chrome extension (ZIP)](https://github.com/johnBgood/local-writing-assistant/releases/download/v0.4.6/LocalWriter-Chrome-0.4.6.zip)** · [All releases](https://github.com/johnBgood/local-writing-assistant/releases)
...
Share the [GitHub release page](https://github.com/johnBgood/local-writing-assistant/releases/tag/v0.4.6) with testers; it contains the DMG, extension ZIP, setup guide and checksums. See [tester installation instructions](docs/TESTERS.md). To generate your own packages from source:
