# LocalWriter 0.4.2 — tester setup
...
Download these ready-to-install files from the [GitHub release](https://github.com/johnBgood/local-writing-assistant/releases/tag/v0.4.2). You do not need to clone or build the repository.

- [LocalWriter-0.4.2-arm64-beta.dmg](https://github.com/johnBgood/local-writing-assistant/releases/download/v0.4.2/LocalWriter-0.4.2-arm64-beta.dmg): the Mac app, these instructions and the extension ZIP.
- [LocalWriter-Chrome-0.4.2.zip](https://github.com/johnBgood/local-writing-assistant/releases/download/v0.4.2/LocalWriter-Chrome-0.4.2.zip): also available separately for convenience.
...
2. Extract `LocalWriter-Chrome-0.4.2.zip` into a permanent folder, such as `~/LocalWriter-Chrome`. If using the ZIP from the DMG, copy it to the Mac before extracting. **Keep the extracted folder** while the extension is installed.
